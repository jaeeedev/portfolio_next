    ...
    <div>
      ...
      <Container>
        ...
        <ProjectText>
          ...
          <br />
          <br />
          데이터가 불러와지기 전이라 함수가 동작하지 않거나 콘솔을 찍어봐도 빈
          배열이 출력되는 등 우여곡절이 많았던 프로젝트였습니다. 파이어베이스를
          단순히 데이터를 저장하고 덮어씌우는 용도로 사용했지만 그 과정에서{" "}
          <Code>GET</Code>, <Code>POST</Code>, <Code>PUT</Code> 방식의 차이점에
        ...
        <ProjectText>
          ...
          방식도 있다는 걸 알게 되어서 충격을 받았습니다. document에서부터
          요소를 찾아 내려가는 것이 아니라 특정 요소를 기준으로 찾기 때문에 탐색
          범위를 좁힐 수 있다고 들었습니다.
          <br />
          <br />
          그리고 이전까지는 바닐라 자바스크립트를 쓰면서 크게 불편하다고 생각해
          본 적이 없었는데 방대한 양(저의 경험 기준..)의 코드를 쓰면서 일일이
          돔을 선택하는 과정이 힘들기도 했고, 바로 직후 리액트로 거의 동일한
          기능들을 구현해보니 극명하게 차이점을 느낄 수 있었습니다.
          <br />
        </ProjectText>
